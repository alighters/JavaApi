...
public interface IGroupService {
     ...
     * @param groupId   群组编号
     * @param accountId   用户编号
     * @param chooseType   操作类型 1：移除用户 2：移除管理员(仅限群组管理员)
     **/
     ...
     * @param accessToken   当前登录用户访问令牌
     * @param groupId   群组编号
     * @param emails   重新邀请用户email 多个邮箱用逗号隔开
     ...
     * @param accessToken   当前登录用户访问令牌
     * @param groupId   群组编号
     * @param accountIds   待审批用户编号 多个用,号隔开
     * @param chooseType   同意1/拒绝0
     **/
